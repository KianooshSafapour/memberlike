...
import 'package:memberlike/modules/main/components/category_view.dart';
import 'package:memberlike/modules/profile/profile_view.dart';
import 'package:memberlike/modules/splash/splash_controller.dart';
                ...
                children: [
                  ...List.generate(dummyCategories.length, (int index) {
                    return GestureDetector(
                      onTap: () {
                        controller
                            .selectedCategory(dummyCategories[index].name);
                        Get.toNamed(Routes.PRODUCTS);
                      },
                      child: CustomImageView(
                        svgPath: serviceIcons[index],
                      ),
                    );
                  })
                ],
