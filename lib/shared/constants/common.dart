...
class CommonConstants {
  ...
  static const String chooseYourDesiredLanguage = 'chooseYourDesiredLanguage';
  ...
  static const double normalRadius = 10.0;
  ...
  static TextStyle kSecondaryTextStyle = TextStyle(
    color:
