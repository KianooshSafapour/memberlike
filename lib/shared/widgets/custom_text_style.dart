...
class CustomTextStyles {
  ...
  // Body text style
  static get bodyMediumBluegray100 =>
      theme.textTheme.bodyMedium!.copyWith(color: appTheme.blueGray100);
  ...
  static get titleSmallBlue200 =>
      theme.textTheme.titleSmall!.copyWith(color: appTheme.blue200);
  static get labelLargeGray400_1 =>
  ...
  static get titleSmallBlue300 =>
      theme.textTheme.titleSmall!.copyWith(color: appTheme.blue300);
  static get titleSmallOnPrimary =>
      theme.textTheme.titleSmall!.copyWith(color: ColorConstants.kPrimaryColor);
  static get titleSmallGreen =>
      theme.textTheme.bodySmall!.copyWith(color: ColorConstants.greenColor);
  ...
  static get titleSmallGray500 =>
      theme.textTheme.titleSmall!.copyWith(color: appTheme.gray500);
  static get titleSmallGray400 =>
  ...
  static get bodySmallBlue300 =>
      theme.textTheme.bodySmall!.copyWith(color: appTheme.blue300);

  static get bodySmallBlue350 => theme.textTheme.bodySmall!.copyWith(
    color: appTheme.blue300,
    fontSize: 14,
  );
  static get bodySmallred =>
      theme.textTheme.bodySmall!.copyWith(color: appTheme.red400);
  ...
  static get labelLargePublicSans => theme.textTheme.labelLarge!.publicSans
  ...
  static get bodySmallBluegray100 =>
      theme.textTheme.bodySmall!.copyWith(color: appTheme.blueGray100);
  // Title text style
  static get titleMediumAmberA700 =>
      theme.textTheme.titleMedium!.copyWith(color: appTheme.amberA700);
  ...
  static get titleSignInBlue400 => theme.textTheme.labelLarge!.inter.copyWith(
    fontWeight: FontWeight.w400,
    color:
        appController.isDarkModeOn.value
            ? ColorConstants.nearlyWhite
...
extension on TextStyle {
  TextStyle get inter {
    return copyWith(fontSize: 18, fontFamily: 'Yekan');
  }

  TextStyle get publicSans {
    return copyWith(fontFamily: 'Yekan');
  }
}
